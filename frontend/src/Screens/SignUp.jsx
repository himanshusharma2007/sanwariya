      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-[#D4AF37] p-6 text-center">
            ...
            <p className="text-white/80 mt-2">Sign up to start your shopping journey</p>
          </div>
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* Username Field */}
              <div>
                <label htmlFor="username" className="block text-[#6F4E37] mb-2 font-medium">
                  Username
                </label>
                <div className="relative">
                  <User className="absolute left-3 top-1/2 -translate-y-1/2 text-[#196F3D]" />
                  <input
                    type="text"
                    id="username"
                    value={username}
